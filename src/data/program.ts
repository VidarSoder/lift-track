...
export const DAYS: ProgramDay[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        restSec: 90,
        tempo: "2-0-1-0",
        equipment: "One dumbbell, seated or standing",
        setup:
          "One bell at shoulder height, other hand on the hip or the bench. Ribs down, glutes tight so you do not lean away from the weight.",
        how: "Press that one dumbbell straight up, lock out over the ear, then lower to the shoulder. Finish the set on one side, then switch.",
        mistakes: "Leaning hard to the side, or turning it into a push press with the legs.",
        progress: "Add 2 kg after 3×10 each arm.",
      },
      {
        id: "weighted-dip",
